...
// this class writes a value to a text field (which should be a textarea field or a div for a RTE (Rich Text) field)
@injectable()
export class NoteFieldValueWriter extends FieldValueWriterBase {
